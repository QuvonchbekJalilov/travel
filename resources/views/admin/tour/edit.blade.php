    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('tour.update', $tour->id)}}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
                            <h2>Mavzu</h2>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title_uz" name="title_uz" value="{{ $tour->title_uz }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="title_ru" class="form-label">Mavzu Rus tilida</label>
                                <input type="text" class="form-control" id="title_ru" name="title_ru" value="{{ $tour->title_ru }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="title_en" class="form-label">Mavzu Ingliz tilida</label>
                                <input type="text" class="form-control" id="title_en" name="title_en" value="{{ $tour->title_en }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="content_uz" name="content_uz" rows="5" required>{{ $tour->content_uz }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="content_ru" class="form-label">Biz haqimizda batafsil Rus tilida</label>
                                <textarea class="form-control" id="content_ru" name="content_ru" rows="5" required>{{ $tour->content_ru }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="content_en" class="form-label">Biz haqimizda batafsil Ingliz tilida</label>
                                <textarea class="form-control" id="content_en" name="content_en" rows="5" required>{{ $tour->content_en }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="validationCustom01" class="form-label">Narx</label>
                                <input type="text" class="form-control" id="validationCustom01" name="price" value="{{ $tour->day}}" placeholder="narx kiriting" required>
                            </div>
                            <div class="mb-3">
                                <label for="validationCustom01" class="form-label">Necha kunlik</label>
                                <input type="text" class="form-control" id="validationCustom01" name="day" placeholder="bu tourning nech kunligini kiriting" value="{{ $tour->day}}" required>
                            </div>
                            ...
                            <div id="imagePreview" class="mb-3">
                                @if ($tour->image)
                                <img src="/storage/{{ $tour->image }}" class="preview-image" alt="">
                                @endif
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <a href="{{ route('tour.index')}}" class="btn btn-danger" type="button">Bekor qilish</a>
                            </div>
                        </form>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
