<x-layouts.admin>
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Biz haqimizda: {{ $about->title_uz }}</h4>
                </div>
                <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><strong>O'zbek tilida:</strong> {{ $about->title_uz }}</p>
                        <p><strong>Rus tilida:</strong> {{ $about->title_ru }}</p>
                        <p><strong>Ingliz tilida:</strong> {{ $about->title_en }}</p>
