            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="{{ route('about.store')}}" method="post" class="needs-validation dropzone" enctype="multipart/form-data" novalidate id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                            ...
                            <div class="mb-3">
                                <label for="validationCustom01" class="form-label">Biz haqimizda batafsil O'zbek tilida</label>
                                <textarea name="content_uz">
                                </textarea>
                            </div>
                            <div class="mb-3">
                                <label for="validationCustom01" class="form-label">Biz haqimizda batafsil Rus tilida</label>
                                <textarea name="content_ru">
                                </textarea>
                            </div>
                            <div class="mb-3">
                                <label for="validationCustom01" class="form-label">Biz haqimizda batafsil Ingliz tilida</label>
